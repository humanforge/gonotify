...
// valid forward transitions — used by service layer to reject illegal jumps
// e.g. can't go DELIVERED -> PENDING
...
const (
	FailureTemporary FailureClass = "TEMPORARY" // retry
	FailurePermanent FailureClass = "PERMANENT" // don't retry
)
